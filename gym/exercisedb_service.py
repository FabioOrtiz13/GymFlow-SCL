    ...
    def get_fallback_exercises():
        ...
        return [
            ...
            },
            {
                ...
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2015/07/Decline-Push-Up.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Pecho',
                'targetMuscles': 'Pectorales',
            ...
            },
            {
                ...
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2022/11/One-arm-triceps-pushdown.gif',
            ...
            # ========== ABDOMEN/CORE ==========
            {
                'id': 'plank',
                'name': 'Plancha',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/10/Push-up-With-Push-up-Bars.gif',
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/10/Push-up-With-Push-up-Bars.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Core',
            ...
            },
            {
                'id': 'russian-twist',
                'name': 'Giros Rusos',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/Heel-Touch.gif',
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/Heel-Touch.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Core',
            ...
            },
            {
                ...
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/02/Decline-Dumbbell-Press.gif',
            ...
            # ESPALDA
            {
                'id': 'cable-row',
                'name': 'Remo en Polea',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/09/Kneeling-High-Pulley-Row.gif',
            ...
            },
            {
                'id': 'close-grip-press',
                'name': 'Press Cerrado',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/10/Close-Grip-Dumbbell-Press.gif',
            ...
            },
            {
                'id': 'mountain-climber',
                'name': 'Escaladores',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2022/07/Cross-Body-Mountain-Climber.gif',
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2022/07/Cross-Body-Mountain-Climber.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Core',
            ...
            },
            {
                ...
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/05/Front-to-Side-Plank.gif',
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2021/05/Front-to-Side-Plank.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Core',
                'targetMuscles': 'Oblicuos',
            ...
            # CARDIO / FUNCIONAL
            {
                'id': 'burpee',
                'name': 'Burpees',
                'imageUrl': 'https://fitnessprogramer.com/wp-content/uploads/2025/08/Burpee-with-Push-Up.gif',
                'gifUrl': 'https://fitnessprogramer.com/wp-content/uploads/2025/08/Burpee-with-Push-Up.gif',
                'equipments': 'Peso Corporal',
                'bodyParts': 'Core',
